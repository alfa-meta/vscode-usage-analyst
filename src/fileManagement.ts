...
export function saveCurrentSessionStatstoTotalUsageStats() {
  ...
  usageStats.totalNumberOfSelectedText +=
    currentSessionUsageStats.currentNumberOfSelectedText;
  usageStats.totalSecondsWhilstWindowIsFocused +=
    currentSessionUsageStats.currentSecondsWhilstWindowIsFocused;
  usageStats.totalSecondsOutsideVSCode +=
    currentSessionUsageStats.currentSecondsOutsideVSCode;
  usageStats.totalSecondsWhilstVSCodeIsActive +=
